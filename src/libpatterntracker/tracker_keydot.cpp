								...
								int flags, const cv::Ptr<cv::FeatureDetector> &blobDetector)
{
	...
	CirclesGridFinderParametersStruct parameters;
	...
	if(flags & cv::CALIB_CB_ASYMMETRIC_GRID)
		parameters.gridType = CirclesGridFinderParametersStruct::ASYMMETRIC_GRID;
	if(flags & cv::CALIB_CB_SYMMETRIC_GRID)
		parameters.gridType = CirclesGridFinderParametersStruct::SYMMETRIC_GRID;
